...
import { FeedbaackType, feedbackTypes } from ".."
import { CloseButton } from "../../CloseButton";
import { ScreenshotButton } from "./ScreenshotButton";
import { api } from "../../../lib/api";
import { Loading } from "../../Loading";

interface FeedbaackContentStepProps {
  feedbackType: FeedbaackType;
  onFeedbackRestartRequested: () => void;
  onFeedbackSent: () => void;
}

export function FeedbaackContentStep({
  feedbackType,
  onFeedbackRestartRequested,
  onFeedbackSent,
}: FeedbaackContentStepProps) {
    ...
    <>
      ...
      <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
        <textarea
          ...
          resize-none focus:outline-none scrollbar-thumb-zinc-700
        ...
        <footer className="flex gap-2 mt-2">
          ...
          <button
            ...
            border-transparent flex-1 flex justify-center
